...
const OPERACOES_POR_TURNO: Record<string, Record<string, string[]>> = {
  "1": {
    ...
    "SÃO JOSÉ DO RIO PRETO": ["simone", "simone regina", "antonio fabio", "grace carrye", "grace carryne"],
  ...
  "2": {
    ...
    "SÃO JOSÉ DO RIO PRETO": ["simone", "simone regina", "fabio alex", "grace carrye"],
    ...
    const results = Object.entries(OPERACOES).map(([cidade, nomesChave]) => {
      ...
      if (alguemEmRede) {
        return {
          ...
          encontrado: true,
          status: "REDE",
          coordenador: alguemEmRede.coordenador || null
        };
      }
      ...
      if (encontrados.length > 0) {
        ...
        if (validos.length > 0) {
          ...
          return {
            ...
            coordenador: principal.coordenador || null
          };
        }
      }
      ...
      if (candidatosValidos.length > 0) {
        ...
        return {
          ...
          coordenador: fallback.coordenador || null
        };
      }
